...
interface FormData {
  name: string;
  collegeName: string; // renamed from idNo
...
const Launchpad = () => {
  ...
  // Update a specific teammate value
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (!formData.collegeName.trim()) {
      alert("Please enter your full college name.");
      return;
    }
        ...
        <div className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-300 max-w-2xl mx-auto">
              Transform your innovative ideas into reality. Submit your
              startup proposal and join the next generation of entrepreneurs.
            </p>
          </div>
          ...
          <Card className="bg-gray-900/50 border-gray-800 backdrop-blur-sm">
            ...
            <CardContent>
              <form onSubmit={handleSubmit} className="space-y-8">
                ...
                <div className="space-y-2">
                  ...
                  >
                    ...
                    <SelectContent className="bg-gray-800 border-gray-700">
                      <SelectItem value="1st-year" className="text-white hover:bg-gray-700">
                        1st Year
                      </SelectItem>
                      <SelectItem value="2nd-year" className="text-white hover:bg-gray-700">
                        2nd Year
                      </SelectItem>
                      <SelectItem value="3rd-year" className="text-white hover:bg-gray-700">
                        3rd Year
                      </SelectItem>
                      <SelectItem value="4th-year" className="text-white hover:bg-gray-700">
                        4th Year
                      </SelectItem>
                      <SelectItem value="graduate" className="text-white hover:bg-gray-700">
                        Graduate
                      </SelectItem>
                      <SelectItem value="postgraduate" className="text-white hover:bg-gray-700">
                        Post Graduate
                      </SelectItem>
                    </SelectContent>
                  </Select>
                ...
                {/* Teammates dynamic inputs */}
                <div className="space-y-2">
                  <div className="flex items-center justify-between">
                    <Label className="text-white">Team Members (if any)</Label>
                    <div className="flex items-center gap-2">
                      <button
                        type="button"
                        onClick={addTeammate}
                        className="inline-flex items-center justify-center rounded-md border bg-[#0ea5e9] px-3 py-1 text-sm font-medium text-white hover:bg-[#0287E0]"
                  ...
                  <div className="space-y-2">
                    {formData.teammates.length === 0 && (
                      <p className="text-sm text-gray-300">No teammates added.</p>
                    )}
                    ...
                    {formData.teammates.map((member, idx) => (
                      <div key={idx} className="flex items-center gap-2">
                        ...
                        <button
                          ...
                          className="inline-flex items-center justify-center rounded-md border bg-red-600 px-3 py-1 text-sm font-medium text-white hover:bg-red-700"
