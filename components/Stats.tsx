...
const statsData = [
  ...
  },
  {
    ...
    count: 5000,
    icon: (
      <svg className="w-8 h-8 text-ecell group-hover:scale-110 transition-transform duration-300" viewBox="0 0 132 95" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path d="M56.763 1.99408C59.651 0.681089 62.8068 0 66.0025 0C69.1982 0 72.354 0.681089 75.242 1.99408L128.853 26.3671C129.787 26.7913 130.577 27.4594 131.134 28.2948C131.691 29.1302 131.991 30.0992 132 31.0907C132.009 32.0822 131.727 33.0561 131.186 33.9009C130.645 34.7457 129.867 35.4271 128.941 35.8672L75.594 61.2641C72.6129 62.6834 69.3303 63.422 66.0025 63.422C62.6747 63.422 59.392 62.6834 56.411 61.2641L11.0055 39.6461V63.333C11.0055 64.7328 10.4261 66.0752 9.39467 67.065C8.36328 68.0548 6.96441 68.6108 5.5058 68.6108C4.04719 68.6108 2.64832 68.0548 1.61692 67.065C0.585529 66.0752 0.00609799 64.7328 0.00609799 63.333V31.4021C-0.0450343 30.3588 0.226299 29.3242 0.786007 28.4283C1.34571 27.5325 2.16883 26.8154 3.15193 26.3671L56.763 1.98352V1.99408ZM22.0049 56.6724V73.8887C22.005 74.583 22.1479 75.2704 22.4254 75.9116C22.7029 76.5528 23.1094 77.1352 23.6218 77.6254L23.6438 77.6571L23.8968 77.8787L24.5568 78.4698C28.0038 81.4182 31.7305 84.051 35.6881 86.3338C43.0357 90.5666 53.6502 95 66.0025 95C78.3548 95 88.9692 90.5666 96.3278 86.3338C100.285 84.051 104.012 81.4182 107.459 78.4698L108.119 77.8787L108.295 77.7098L108.361 77.6465L108.372 77.6359L108.394 77.6254C108.905 77.1343 109.309 76.5516 109.585 75.9104C109.86 75.2692 110.001 74.5822 110 73.8887V56.6618L80.4777 70.722C75.9786 72.8632 71.0245 73.9774 66.0025 73.9774C60.9805 73.9774 56.0264 72.8632 51.5273 70.722L22.0049 56.6618V56.6724Z" fill="currentColor" fillOpacity="0.8" />
      </svg>
    ),
  },
  {
  ...
  },
  {
    ...
    count: 500,
    icon: (
      <svg className="w-8 h-8 text-ecell group-hover:scale-110 transition-transform duration-300" viewBox="0 0 98 96" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path d="M1.2294 52.7305C0.645308 53.1301 0.233371 53.7279 0.0734229 54.4081C-0.0865256 55.0884 0.0169052 55.8026 0.36367 56.4124L7.42017 68.3863C8.14433 69.6136 9.805 70.1205 11.1063 69.4962L32.657 59.2671V96H43.5466V54.0912L65.7125 43.5633L51.4471 19.338L1.2294 52.7305ZM95.0384 10.8217C92.104 5.84889 87.2749 2.22136 81.6125 0.736493C75.95 -0.748372 69.9177 0.030944 64.8413 2.90315C59.8866 5.70454 56.6305 10.1547 55.0352 15.1172L71.239 42.6295C76.4171 43.7607 81.9817 43.2165 86.9474 40.4151C92.0246 37.5422 95.7294 32.8104 97.2467 27.2606C98.7641 21.7108 97.9697 15.7976 95.0384 10.8217Z" fill="currentColor" fillOpacity="0.8" />
      </svg>
    ),
  },
];
            ...
            >
              ...
              <span
                className={classNames(
                  "text-3xl md:text-4xl lg:text-5xl font-bold tracking-tight text-white mb-1",
                  ibmPlex.className
                )}
              >
                <Count number={stat.count} duration={2} />
              </span>
              <span className="text-xs md:text-sm text-ecell uppercase tracking-[0.25em] font-semibold">
                {stat.label}
              </span>
            </motion.div>
          ))}
